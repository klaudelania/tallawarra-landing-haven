...
const videoMedia = [
  { type: 'video', src: "https://player.vimeo.com/video/1107312113?badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1&loop=1&muted=1" }, // Vimeo embedded video with autoplay, loop and start muted
];
