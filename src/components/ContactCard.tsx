...
const ContactCard = () => {
  ...
  return (
    <div className="relative">
      ...
      <Card className="w-full max-w-xs bg-white/20 backdrop-blur-lg rounded-xl relative z-10 border border-white/60">
        <div className="p-6">
          ...
          <a href={googleMapsUrl} target="_blank" rel="noopener noreferrer" className="block">
            <Button className="w-full gap-2 bg-primary/80 backdrop-blur-sm hover:bg-primary border border-white/20 text-white">
