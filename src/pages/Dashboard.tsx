    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-green-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="text-2xl font-bold">TALLAWARRA</div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h1 className="text-3xl font-bold mb-6">Welcome to Tallawarra Residential Subdivision</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
              <h2 className="text-xl font-bold mb-3">Project Overview</h2>
              <p className="text-gray-700">
                Explore the latest developments and plans for the Tallawarra Residential Subdivision.
              </p>
            </div>
